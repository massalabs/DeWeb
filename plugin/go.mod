...
require (
	...
	github.com/massalabs/station-massa-hello-world v0.0.11-0.20240503070604-6b14a27fcdff // indirect
	github.com/massalabs/station-massa-wallet v0.4.5 // indirect
